...
/* Manual
 * ,-----------------------------------------------------------------------------------.
 * | ____ |Accel1|Accel2|Accel3|      |      |      |      |      |      |      | ____ |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ____ |Click1| MUp  |Click3|      |      | WLeft| WDown| WUp  |WRight|      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | ____ | MLeft| MDown|MRight|Click2|      | Left | Down |  Up  | Right|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | ____ | ____ | ____ | ____ | ____ |      | Home | PGDN | PGUP |  End |      | ____ |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ____ | ____ | ____ | ____ | ____ | ____   ____ | ____ | ____ | ____ | ____ |Qwerty|
 * `-----------------------------------------------------------------------------------'
 */
[_MANUAL] = LAYOUT_preonic_grid(
  ...
  _______, KC_BTN1, KC_MS_U, KC_BTN3, XXXXXXX, XXXXXXX, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, XXXXXXX, XXXXXXX,
  _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN2, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,XXXXXXX, XXXXXXX,
  _______, _______, _______, _______, _______, XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, _______,
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  XXXXXXX, XXXXXXX, KC_QUOT, KC_LPRN, KC_RPRN, XXXXXXX, KC_LBRC, KC_RBRC, KC_SCLN, XXXXXXX, XXXXXXX, XXXXXXX,
  _______, XXXXXXX, XXXXXXX, KC_NUBS, KC_MINS, XXXXXXX, KC_SLSH, KC_PLUS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  XXXXXXX, XXXXXXX, KC_DQUO, KC_LT,   KC_GT,   XXXXXXX, KC_LCBR, KC_RCBR, KC_COLN, XXXXXXX, XXXXXXX, XXXXXXX,
  _______, XXXXXXX, XXXXXXX, KC_PIPE, KC_UNDS, XXXXXXX, KC_QUES, KC_EQL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
