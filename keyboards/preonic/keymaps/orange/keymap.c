 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |Lowest| GUI  | Alt  |Lower |    Space    | Raise| Enter| RAlt |      |      |
 * `-----------------------------------------------------------------------------------'
 */
...
[_LOWEST] = LAYOUT_preonic_grid(
  ...
  KC_NO,   KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_NO, KC_NO, KC_NO, KC_P1,   KC_P2,   KC_P3,   KC_PENT,
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_PCMM, KC_P0,   KC_PDOT, KC_NO
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_MINS, KC_NUBS, KC_SLSH, KC_EQL,  KC_NO,   KC_NO,   KC_NO,   KC_NO,
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_UNDS, KC_PIPE, KC_QUES, KC_PLUS, KC_NO,   KC_NO,   KC_NO,   KC_NO,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, RESET,   DEBUG,   _______, _______, _______, _______, TERM_ON, TERM_OFF,_______, _______, KC_NO,
